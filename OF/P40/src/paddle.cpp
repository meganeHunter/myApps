...
void paddle::update()
{
	...
	if(pos1.y < table0.y + height/2 - 24)
	{
		pos1.y = table0.y + height/2 - 24;
	}
	if(pos1.y > tableF.y + height/2 + 3)
	{
		pos1.y = tableF.y + height/2 + 3;
	}

	if(pos2.y < table0.y + height/2 - 24)
	{
		pos2.y = table0.y + height/2 - 24;
	}
	if(pos2.y > tableF.y + height/2 + 3)
	{
...
void paddle::setPos1(float pPos1y)
{
	pos1.y = pPos1y;
}
...
void paddle::setPos2(float pPos2y)
{
	pos2.y = pPos2y;
}
